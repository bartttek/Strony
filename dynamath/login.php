<?php
    ...
    header("Location: dynamath.html"); // Przekierowanie do strony głównej
    exit();
}
    ...
    if ($result->num_rows === 1) {
        ...
        if (password_verify($password, $hashedPassword)) {
            ...
            header("Location: dynamath.html"); // Przekierowanie do strony głównej po zalogowaniu
            exit();
        } else {
...
<body>
	...
	<a href="dynamath.html">Kontynuuj jako gość</a><br>
</body>
</html>